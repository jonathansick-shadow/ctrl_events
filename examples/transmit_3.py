...
if __name__ == "__main__":
    ...
    subroot1 = datap.DataProperty.createPropertyNode("subroot1")
    ...
    subsubroot = datap.DataProperty.createPropertyNode("subsubroot")
    ...
    subroot2 = datap.DataProperty.createPropertyNode("subroot2")
